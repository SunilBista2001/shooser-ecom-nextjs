...
const Banner = () => {
  return (
    <section className="relative">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 gap-6  lg:gap-0 md:grid-cols-2 items-center justify-between px-4 sm:px-6 lg:px-8 pt-10 sm:pt-20 md:pt-48 pb-20 sm:pb-2 ">
        <div className="flex flex-col gap-y-4 justify-center items-center text-center sm:items-start sm:text-start">
          <h1 className="font-bold tracking-tighter text-3xl sm:text-5xl lg:text-6xl max-w-sm sm:max-w-4xl">
            An open source e-commerce project built on
          ...
          <h2 className="max-w-md sm:max-w-[42rem] leading-normal text-muted-foreground text-sm sm:text-xl sm:leading-8">
            Specially designed for developers so that they can go out after
            frustration of code
          </h2>
